...
par(mfrow = c(1,1))
plot(as.numeric(dff$Global_active_power)~dff$datetime, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
dev.copy(png,"C:\\Users\\vadisheshan\\Desktop\\Data Scientist\\Course 4\\ExData_Plotting1\\plot2.png",height=480, width=480)
dev.off()