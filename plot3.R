...
par(mfrow = c(1,1))
with(dff,{
    plot(as.numeric(Sub_metering_1)~datetime, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")
...
dev.copy(png,"C:\\Users\\vadisheshan\\Desktop\\Data Scientist\\Course 4\\ExData_Plotting1\\plot3.png", height=480, width=480)
dev.off()
